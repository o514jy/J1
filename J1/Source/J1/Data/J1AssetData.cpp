...
void UJ1AssetData::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
...
FSoftObjectPath UJ1AssetData::GetAssetPathByName(const FName& AssetName)
{
...
const FAssetSet& UJ1AssetData::GetAssetSetByLabel(const FName& Label)
{
